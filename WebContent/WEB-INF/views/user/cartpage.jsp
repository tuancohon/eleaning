    ...
    <script>
     ...
     // In Common Nav
       ...
       //RSPass
        ...
        var button = $('.checkout');
        var numcart = ${sessionScope.cart.size() != 0 ? sessionScope.cart.size() :0 };
       if (numcart==0){
                    ...
                    // AJAX Checkout
                     $.ajax({
                         ...
                         data:{
                           ...
                           success: function (response) {
                        	   if(response== "not"){
                        		   swal('Fail', "not enough cash to pay !! You can check your cash ", "warning");
                        	   }
                        	   if(response == "true"){
   								async function sequence(){
                		...
                		async function sequence(){
                 			await swal("Changes are not saved !!", {icon: "success",})
                 			await location.reload(true);
                    	}
                    		sequence();
                	  }
